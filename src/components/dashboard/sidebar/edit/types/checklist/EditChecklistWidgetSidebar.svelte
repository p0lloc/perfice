<script lang="ts">
    ...
    import EditChecklistConditionCard
        from "@perfice/components/dashboard/sidebar/edit/types/checklist/EditChecklistConditionCard.svelte";
    import {faPlus} from "@fortawesome/free-solid-svg-icons";
    import IconButton from "@perfice/components/base/button/IconButton.svelte";
    import EditChecklistConditionModal
        from "@perfice/components/dashboard/sidebar/edit/types/checklist/EditChecklistConditionModal.svelte";
    import {deleteIdentifiedInArray, updateIdentifiedInArray} from "@perfice/util/array";
    import {tags} from "@perfice/app";

    let {settings, onChange, forms}: {
        settings: DashboardChecklistWidgetSettings,
        onChange: (settings: DashboardChecklistWidgetSettings) => void,
        forms: Form[],
