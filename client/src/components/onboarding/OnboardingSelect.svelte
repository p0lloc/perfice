...
<h1 class="text-4xl md:text-7xl font-bold text-gray-600 dark:text-white">
    {page.title}
</h1>
<p class="text-xl mt-2">{page.description}</p>
<div
    class="flex flex-col gap-4 mt-4 max-h-[55vh] md:max-h-[45vh] overflow-y-scroll scrollbar-hide"
>
